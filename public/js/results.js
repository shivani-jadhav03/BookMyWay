class ResultsPageHandler {
    ...
    async handleBooking(optionId) {
        ...
        if (!option) {
            showToast('Travel option not found. Please try again.', 'error');
            return;
        }
        ...
        if (!searchDate) {
            showToast('Search date not found. Please try again.', 'error');
            return;
        }
        ...
        switch (option.type) {
            ...
            case 'bus':
                ...
                break;
            default:
                showToast('Unknown transport type. Please try again.', 'error');
        }
    }
